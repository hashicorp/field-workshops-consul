...
resource "aws_route" "eks_dev_to_ecs_dev" {
  count                     = length(local.eks_dev_public_route_table_ids)
  route_table_id            = local.eks_dev_public_route_table_ids[count.index]
...
resource "aws_route" "ecs_dev_to_eks_dev" {
  count                     = length(local.ecs_dev_public_route_table_ids)
  route_table_id            = local.ecs_dev_public_route_table_ids[count.index]
