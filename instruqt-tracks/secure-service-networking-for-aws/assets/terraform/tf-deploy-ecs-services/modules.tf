module "acl_controller" {
  ...
  consul_server_http_addr           = data.terraform_remote_state.hcp.hcp_consul_private_endpoint_url
...
module "example_client_app" {
  ...
  retry_join                     = [substr(data.terraform_remote_state.hcp.hcp_consul_private_endpoint_url, 8, -1)]
  tls                            = true
  ...
  consul_datacenter              = data.terraform_remote_state.hcp.consul_datacenter
