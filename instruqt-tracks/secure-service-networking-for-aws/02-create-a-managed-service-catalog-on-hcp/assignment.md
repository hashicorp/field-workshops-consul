...
The HPC Consul deployment takes a few minutes to create the resources. You can monitor the progress of the deployment using the following command:
...
HCP Consul generates the registration file required for connecting consul agents to the HCP Consul cluster. To read the consul config file, execute the following command:
